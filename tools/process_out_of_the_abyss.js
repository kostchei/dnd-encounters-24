...
async function main() {
    ...
    for (const entry of parsedMonsters) {
        ...
        // Handling names with parenthesis like "Basilisk (Infant)"
        // 5etools might store them differently or not have them.
        // We try exact match first

        let bestiaryData = bestiaryMap.get(name.toLowerCase());

        // Manual mapping or fuzzy logic if needed
        // E.g. "Hook Horror (Infant)" -> might not exist in 5etools default bestiary or under different name
        // "Manes" -> "Manes"
